...
@Component({
  ...
  template: `
    ...
    <app-modal [(visible)]="modalVisible" title="Nouveau emploi">
      <form [formGroup]="itemForm" (ngSubmit)="submit()">
        <input type="text" formControlName="title" placeholder="Intitulé">
              <input type="text" formControlName="company" placeholder="Entreprise">
...
export class EmploiComponent implements OnInit {
  ...
  toggleLike(item: any) { this.api.post('jobs/' + item.id + '/like', {}).subscribe(() => this.loadItems()); }
