...
@Component({
  ...
  template: `
    ...
    <app-modal [(visible)]="modalVisible" title="Nouveau marketplace">
      <form [formGroup]="itemForm" (ngSubmit)="submit()">
        <input type="text" formControlName="title" placeholder="Titre">
              ...
              <input type="text" formControlName="price" placeholder="Prix">
...
export class MarketplaceComponent implements OnInit {
  ...
  async submit() {
    ...
    this.api.post('marketplace', formValue).subscribe(() => {
