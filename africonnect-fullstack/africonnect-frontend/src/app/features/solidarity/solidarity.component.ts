...
@Component({
  ...
  template: `
    ...
    <app-modal [(visible)]="modalVisible" title="Nouveau solidarite">
      <form [formGroup]="itemForm" (ngSubmit)="submit()">
        <input type="text" formControlName="title" placeholder="Titre">
              <input type="text" formControlName="type" placeholder="Type (aide/demande)">
...
export class SolidariteComponent implements OnInit {
  ...
  async submit() {
    ...
    this.api.post('solidarity', formValue).subscribe(() => {
