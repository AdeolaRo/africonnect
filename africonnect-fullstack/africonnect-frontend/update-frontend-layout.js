...
const appCompPath = path.join(process.cwd(), 'src/app/app.component.ts');
const correctedContent = `import { Component, OnInit } from '@angular/core';
...
fs.writeFileSync(appCompPath, correctedContent, 'utf8');
console.log('✅ app.component.ts totalement réécrit et corrigé');